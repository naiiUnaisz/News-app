...
class NewsController extends GetxController {
  ...
  Future<void> fetchTopHeadLines({String? category}) async {
    // setting loading dan error yang awalnya false jadi true, dn errornya di kosongin
    try {
      _isLoading.value = true;
      _error.value = '';
  
  // kalo udah loading nanti bakalan ngambil responses dari news servis bagian function getTopHeadline
  // dan artikelnya bakalan muncul sesuai dengan kategori yang di oilih.
...
// fungsi buat search berita berdasarkan query yang dimasukkan user, nanti bakalan dipanggil di search page
  Future<void> searchNews (String query) async{
    ...
    try{
      ...
      _error.value = e.toString();
      Get.snackbar(
        'Erorr','Failed to search news: ${e.toString()}',
        snackPosition: SnackPosition.BOTTOM,
      );
    } finally {
