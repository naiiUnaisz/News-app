...
class HomePage extends GetView<NewsController> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            // obx itu widget dart get x
            // yang fungsinya buat bikin ui aouto update kalo kalo state yang berubah
            // jadi kita bisa pantau isLoading, error, sama articles di news controller
            child: Obx(() {
  ...
  void _showSearchDialog(BuildContext context) {
    ...
    showDialog(
      context: context, 
      builder: (context) => AlertDialog(title:  Text('Search News'),
      content: TextField(
